...
export default {
  nb: {
    ...
    'søkerFraBestemtMåned.hjelpetekst-innhold.overgangsstønad':
      ...
      'Du kan ha rett til stønad i inntil 3 måneder før du søker. Det vil si fra og med april 2020. <br><br>' +
      'Hvis du er gravid, kan du ha rett til overgangsstønad fra måneden før fødsel. ' +
      'Hvis du har fått barn i løpet av de siste 3 månedene, kan du få stønad i inntil 5 måneder før du søker. Det vil si fra og med februar 2020. <br><br>' +
  ...
  nn: {
    ...
    'barnadine.hjelpetekst.innhold': 'Lorem ipsum hjelpetekst jadda',
    'barnadine.infohentet':
      'Informasjonen er hentet fra Folkeregisteret, og viser kun barn under 18 år. Hvis noe ikke stemmer, kan du endre informasjonen hos Folkeregisteret.',
    'barnadine.leggtil': 'Legg til barn',
    'barnadine.advarsel.borikke':
      'Når barnet ikke bor hos deg, har du ikke rett til stønad til enslig mor eller far',
    'barnadine.advarsel.skalikkebo':
